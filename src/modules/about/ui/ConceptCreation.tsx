      ...
      <div ref={vantaRef} className="w-full h-screen relative overflow-hidden">
        <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-tl from-black/10 to-black/5">
          <div className="text-center px-4">
            <p className="text-4xl sm:text-5xl md:text-6xl lg:text-6xl uppercase text-white mb-6">
              From concept to creation
            </p>
            <p className="text-4xl font-extralight sm:text-5xl md:text-5xl lg:text-5xl uppercase text-white mb-6">
